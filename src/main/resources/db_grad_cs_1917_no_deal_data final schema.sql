...
CREATE TABLE `counterparty` (
  `counterparty_id` int(11) NOT NULL auto_increment,
...
INSERT INTO counterparty(counterparty_name, counterparty_status, counterparty_date_registered) SELECT DISTINCT(dealfull.counterparty_name),dealfull.counterparty_status, dealfull.counterparty_date_registered
FROM dealfull LEFT JOIN counterparty
ON dealfull.counterparty_name=counterparty.counterparty_name;
...
INSERT INTO deal
SELECT dealfull.deal_id, dealfull.deal_time,counterparty.counterparty_id,
instrument.instrument_id,dealfull.deal_type, dealfull.deal_amount, dealfull.deal_quantity
FROM dealfull LEFT JOIN deal
ON dealfull.deal_id=deal.deal_id
...
INSERT INTO instrument(instrument_name) SELECT DISTINCT(dealfull.instrument_name)
FROM dealfull LEFT JOIN instrument
ON dealfull.instrument_name=instrument.instrument_name;
